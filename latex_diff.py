...
def generate_list_of_used_tex_files(main_tex_file):
    used_files=[]
...
def main():
    changed_files,changed_basedir=generate_list_of_used_tex_files(args.changed)
    orig_files,orig_basedir=generate_list_of_used_tex_files(args.orig)
